...
public static class WebSocketExtensions
{
    ...
    public static async Task<WebSocketCompleteMessageResult> ReceiveFullMessageAsync(this WebSocket webSocket, int chunkSize, CancellationToken cancellationToken)
    {
        ...
        return new WebSocketCompleteMessageResult(compoundBuffer.ToArray(), receiveResult.MessageType, true, receiveResult.CloseStatus, receiveResult.CloseStatusDescription);
    }
