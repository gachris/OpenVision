...
/// <summary>
/// Represents a paged response containing a collection of <see cref="DatabaseResponse"/> objects.
/// </summary>
public class DatabasePagedResponse : PagedResponse<IEnumerable<DatabaseResponse>>, IPagedResponse<IEnumerable<DatabaseResponse>>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DatabasePagedResponse"/> class with the specified page number, page size, first page URI, last page URI, total number of pages, total number of records, next page URI, and previous page URI.
    /// </summary>
    ...
    /// <param name="response">The response payload collection of type <see cref="DatabaseResponse"/>.</param>
    ...
    public DatabasePagedResponse(int page,
                                 int size,
                                 Uri? firstPage,
                                 Uri? lastPage,
                                 int totalPages,
                                 ...
                                 Uri? nextPage,
                                 Uri? previousPage,
                                 ResponseDoc<IEnumerable<DatabaseResponse>> response,
                                 Guid transactionId,
