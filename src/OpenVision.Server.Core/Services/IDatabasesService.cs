...
/// <summary>
/// Defines the interface for the databases service, which is responsible for handling requests and responses related to databases.
/// </summary>
public interface IDatabasesService
{
    ...
    Task<DatabasePagedResponse> GetAsync(DatabaseBrowserQuery query, CancellationToken cancellationToken = default);
