...
using OpenVision.IdentityServer.STS.Identity.Configuration.ApplicationParts;
...
using OpenVision.IdentityServer.STS.Identity.Helpers.Localization;
using OpenVision.IdentityServer.STS.Identity.Services;
